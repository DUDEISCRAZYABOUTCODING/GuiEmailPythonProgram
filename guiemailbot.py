...
import urllib.request                 # <------ Internet checks

from tkinter import *          

root = Tk()
ROOT_GEOMETRY = root.geometry("300x250")
ROOT_TITLE = root.title("Auto Email Bot")
    ...
    def internet_true():
        ...
        def emailsendstart():
            ...
            def Completep():
                ...
                server = smt.SMTP('SMTP.gmail.com')
                server.starttls()
                ...
                Num.pack_forget()
                Ok.pack_forget()
                Sent = Label(root, text="Successfully Sent Email!")
